...
class TestPickupByBatchUnserializable extends StatefulWidget {
  String pkCode;
  String locationCode;
  double qty;
  int batchNo;
  ...
  TestPickupByBatchUnserializable(this.batchNo, this.qty, this.pkCode, this.locationCode,
      this.id, this.order, this.index,this.remainQty);

  @override
  State<TestPickupByBatchUnserializable> createState() => _TestPickupByBatchUnserializableState();
}

class _TestPickupByBatchUnserializableState extends State<TestPickupByBatchUnserializable> {
            ...
            child: RoundedButtons(
              ...
              onTap: () async {
                ...
                _scanedSerialId.isNotEmpty
                  ...
                  sale_packing_type_detail_code,
                  qty: widget.remainQty!.toInt()<widget.qty.toInt()? widget.remainQty!.toDouble():_scanedSerialId.length.toDouble(),
                )
                    : null;
                _scanedSerialId.isNotEmpty
