...
class _PickUpOrderByBatchSaveLocationState
  ...
  List _currentScannedLocationList = [];
  ...
  Future searchHandling() async {
    ...
    return pickUpLocationPackTypeDetails(
        widget.purchaseDetail, _currentScannedLocationList[0]);
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      location.length==1?'':_currentScannedLocationList.clear();
      log(location.length.toString());
      log("locatiuon"+_currentScannedLocationList.toString());
      pickUpLocationPackTypeDetails(
          widget.purchaseDetail, _currentScannedLocationList[0]);
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _currentScannedLocationList.isNotEmpty &&
                  location.contains(_currentScannedLocationList[0])
                  ? FutureBuilder(
                  future: pickUpLocationPackTypeDetails( widget.purchaseDetail, _currentScannedLocationList[0]),
                  builder: (context, snapshot) {
                    switch (snapshot.connectionState) {
                      case ConnectionState.waiting:
                        return const Center(
