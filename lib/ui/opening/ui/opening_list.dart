...
class _OpeningStockListState extends State<OpeningStockList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(StringConst.openingStocks, style: TextStyle(
                  ...
                  child: DropdownButton<String>(
                    ...
                    onChanged: (String? value) {
                      ...
                      setState(() {
                        ...
                        value == "Today" ? StartdateController.text = DateTime
                            .now()
                            .year
                            .toString() + '-' + DateTime
                            .now()
                            ...
                            .day
                            .toString()
                            : value == "Yesterday" ? StartdateController.text =
                            DateTime
                                .now()
                                ...
                                .day
                                .toString()
                            : value == "Last Week" ? StartdateController.text =
                            DateTime
                                .now()
                                ...
                                .toString() : ""
                        ;
                        value == "Today" ? EnddateController.text = DateTime
                            .now()
                            .year
                            .toString() + '-' + DateTime
                            .now()
                            ...
                            .day
                            .toString()
                            : value == "Yesterday" ? EnddateController.text =
                            DateTime
                                .now()
                                .subtract(Duration(days: 1))
                                .year
                                ...
                                .day
                                .toString()
                            : value == "Last Week" ? EnddateController.text =
                            DateTime
                                .now()
                                .year
                                .toString() + '-' + DateTime
    ...
    return data != null
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            onTap: () {
              goToPage(
                  context, OpeningStockDetails(
                  data[index].purchaseNo.toString(),
                  data[index].createdByUserName.toString(), data[index].id));

            },
            child: Card(
              margin: kMarginPaddSmall,
              color: data[index].dropped == false ? Colors.white : Colors.grey
                  .shade200,
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          ...
                          child: Text('${data[index].createdByUserName!
  ...
  * TODO Keep All Network Calls in Separate Files*/
  Future<List<Result>?>? listOpeningStocks() async {
    ...
    final response = await http.get(
        Uri.parse('https://$finalUrl${StringConst
            .openingStockMaster}item=&supplier=&date_after=${StartdateController
            .text}&date_before=${EnddateController.text}'),
        headers: {
