...
import 'newSaleRepackage/repackageListings.dart';
String _scanLocationNo = '';
class RemoveRepackagedPack extends StatefulWidget {
  ...
  RemoveRepackagedPack(this.masterId,this.id,this.rePackageId,this.packCodeList,this.remPackCodes,this.serialvalueDict,this.newSerialvalueDict);

  @override
  State<RemoveRepackagedPack> createState() => _RemoveRepackagedPackState();
}

class _RemoveRepackagedPackState extends State<RemoveRepackagedPack> {
...
log(widget.id.toString());
    final response = await http.get(
        Uri.parse('https://${finalUrl}${StringConst.rePackageListings}?id=${widget.rePackageId}&sale_master=${widget.masterId}'),
        headers: {
          'Content-type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer ${prefs.get("access_token")}'
        });
    log('https://${finalUrl}${StringConst.rePackageListings}?id=${widget.rePackageId}&sale_master=${widget.masterId}');
    ...
    if (response.statusCode == 401) {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        log("Re Packs"+newRePackCodes.toString());
        saveRePackCodeList(newRePackCodes);
...
setState(() {
  ...
  printPackCodes( data ) {
    ...
    return  showMorePickUpLocations(data.toString(),);
  ...
  void savePackCodeList(List<SalePackingTypeCode> packingType) {
    ...
    totalSerialNo = _packCodesList.length;
    log("hello"+_packCodesList.toString());
    log("hello Id"+_packCodesID.toString());
