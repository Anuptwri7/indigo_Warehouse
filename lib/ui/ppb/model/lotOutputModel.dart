class LotOutputDetailModel {
  int? count;
  Null? next;
  Null? previous;
  List<Results>? results;

  LotOutputDetailModel({this.count, this.next, this.previous, this.results});

  LotOutputDetailModel.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    next = json['next'];
