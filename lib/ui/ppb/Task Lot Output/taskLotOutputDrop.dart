...
import 'package:indigo_paints/ui/ppb/Task%20Lot%20Output/summary.dart';
...
class LotOutputMasterPage extends StatefulWidget {
  const LotOutputMasterPage({Key? key}) : super(key: key);

  @override
  State<LotOutputMasterPage> createState() => _LotOutputMasterPageState();
}

class _LotOutputMasterPageState extends State<LotOutputMasterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("FG Drop List", style: TextStyle(color: Colors.black, fontSize: 15,fontWeight: FontWeight.bold),),
    ...
    return data != null
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
              ...
              :
              goToPage(context,
                  ScanToDropLotOutputPage(id:data[index].id.toString() ));
            },
            child: Card(
              margin: kMarginPaddSmall,
              color: data[index]
                  .dropped==true?Colors.grey.shade400:Colors.white,
