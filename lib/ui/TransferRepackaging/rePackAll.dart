...
class TransferRePackAll extends StatefulWidget {
  String masterId;
  List packCodes =[];
  Map<String, String> serialvalueDict = {};


  TransferRePackAll(this.masterId,this.packCodes,this.serialvalueDict);

  @override
  State<TransferRePackAll> createState() => _TransferRePackAllState();
}

class _TransferRePackAllState extends State<TransferRePackAll> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Transfer All Repackaging'),
  ...
  Future<List<SalePackingTypeCode>?> RepackagingListServices() async {
    ...
    final response = await http.get(
        ...
        // Uri.parse('http://$finalUrl:8081${StringConst.transferRepackageListGetInfo}?id=&department_transfer_master=${widget.masterId}'),
        headers: {
    ...
    //     .getOrdersWithToken();
    log("http://$finalUrl:8081${StringConst.transferRepackageListGetInfo}?id=&department_transfer_master=${widget.masterId}");
    log("${response.body}");
  ...
  Future dropCurrentItem(locationCode, packCode)  async {
    ...
    final response = await http.post(
        // Uri.parse('${StringConst.protocol}$finalUrl:8081${StringConst.postRepackAll}'),
        Uri.parse('${StringConst.protocol}$finalUrl${StringConst.postRepackAll}'),
        headers: {
          'Content-type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer ${prefs.get("access_token")}'
